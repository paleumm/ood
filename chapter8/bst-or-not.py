...
def check_binary_search_tree_(root, l, r):
    if not root:
        return True

    if not (root.data < r and root.data > l):
        return False
    
    return (check_binary_search_tree_(root.left, l, root.data) and check_binary_search_tree_(root.right, root.data, r))
...
print(check_binary_search_tree_(tree.root, -1, 101)) # case 13,14 -> input : 0, input : 100