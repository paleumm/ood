...
def reverseLL(LL:DoublyLinkedList) -> DoublyLinkedList:
    LL_out = DoublyLinkedList()
    
    cur = LL.tail
    while cur.prev is not LL.head:
        LL_out.append(str(cur.prev.value))
        cur = cur.prev
    
    return LL_out

def mergeLL(LL1:DoublyLinkedList, LL2:DoublyLinkedList) -> DoublyLinkedList:
    LL = DoublyLinkedList()
